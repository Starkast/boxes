...
source "vmware-vmx" "autogenerated_1" {
  ...
  #  sata0:0.fileName = ".packer-vmware-vmx/20G-1.vmdk"
  #  sata0:0.present = "TRUE"
  #  sata0:0.redo = ""
  # downside is "output_directory" needs to be hard coded now
  # output_directory     = "_packer-openbsd-${var.major_version}.${var.minor_version}-${var.arch}-vmware"
  output_directory     = ".packer-vmware-vmx"
  ...
  # from https://github.com/hashicorp/packer-plugin-vmware/blob/v1.0.10/example/pkrvars/debian/fusion-13.pkrvars.hcl
  vmx_data             = {
